...
public class wordcount {
    private static final String OUT = "hdfs://192.168.1.103:9000/wordcount/output/";
    ...
    public static void main(String[] args) throws Exception{
        ...
        conf.set("yarn.resourcemanager.hostname","192.168.1.103");
        ...
        org.apache.hadoop.mapreduce.lib.input.FileInputFormat.setInputPaths(job,new Path("hdfs://192.168.1.103:9000/wordcount/input/"));
